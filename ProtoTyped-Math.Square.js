...
//numbers from float type inside a string still not supported...
...
Quadratic_Equation(12, 12000, 8); // Altere os valores nesta linha, são respectivamente os valores de (a, b e c) em uma equação do segundo grau.
